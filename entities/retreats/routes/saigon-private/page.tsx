...
import { RevealObserver, VideoCarousel } from "@/entities/site";
import Link from "next/link";
import Image from "next/image";
import { PhotoSlider } from "@/entities/retreats/ui/experience/PhotoSlider";
import {
  FAQS,
  FILTER_BULLETS,
  INCLUDED,
  ...
  VALUE_STACK,
  VALUE_TOTAL,
} from "@/entities/retreats/private-session";
import { faqPageSchema, jsonLd } from "@/entities/site";
      ...
      <section className="section wf-section--white">
        <div className="container">
          ...
          <div className="meet-dave">
            ...
            <Image src="/images/saigon-private/quan.jpg" alt="Quan, Retreat Host at Edge8" width={1000} height={750} className="meet-dave-img reveal" />
          </div>
          {/* Dave + Trac — secondary */}
          <div className="rt-team-secondary">
            <div className="rt-team-card reveal">
              <Image src="/images/dave-headshot.webp" alt="Dave Hajdu, Founder & CAIO" width={340} height={340} />
              <div>
            ...
            <div className="rt-team-card reveal">
              <Image src="/images/saigon-private/trac.jpg" alt="Trac, Lead Engineer" width={1000} height={750} />
              <div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="rt-stay-grid reveal">
            <Image src="/images/saigon-private/apartment.jpg" alt="Two-bedroom apartment at the AIO-pad in Lumiere Riverside" width={1280} height={960} />
            <Image src="/images/saigon-private/pool.avif" alt="The 50-metre rooftop pool at Lumiere Riverside" width={968} height={575} />
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="rt-xp-teaser reveal">
            <div className="rt-xp-teaser-media">
              <Image src="/experience/welcome.jpg" alt="The Saigon riverside at first light" width={1600} height={872} />
            </div>
