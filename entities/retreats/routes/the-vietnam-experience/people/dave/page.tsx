...
import { SubpageFrame, PageHeader, Block } from "@/entities/retreats/ui/experience/Subpage";
import { PlaceholderImage } from "@/entities/retreats/ui/experience/PlaceholderImage";
...
export default function DavePage() {
  return (
    <SubpageFrame back={BACK} next={{ href: "/the-vietnam-experience/people/quan", label: "Quan" }}>
      ...
      <PlaceholderImage label="Photo: Dave" aspect="4 / 5" maxWidth="24rem" className="u-mt-7" />
