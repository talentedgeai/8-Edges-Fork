...
import { usePrefersReducedMotion } from "@/kernel/ui/hooks/usePrefersReducedMotion";
  ...
  return (
    ...
    >
      <div
        ...
        style={{ aspectRatio: ratio }} /* layout-ok: ratio from props */
        onTouchStart={onTouchStart}
        onTouchEnd={onTouchEnd}
      >
        <div
          className="xp-gallery-track"
          style={{ /* layout-ok: carousel transform from the active index */
