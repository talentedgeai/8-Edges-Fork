    ...
    <main>
        ...
        <div className="container">
          <div className="about-hero-inner">
            <div className="reveal">
              <span className="section-label u-inline-block u-mb-4">The Founder POV</span>
              <h1 className="section-title u-mb-5">We&apos;ve Run AI Programs in 30+ Companies. We Built Ours First.</h1>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="partners-grid u-mt-8">
      ...
      <section className="section section--tint">
        <div className="container">
          <div className="reveal u-center-text">
            <h2 className="section-title u-mb-8">Get In Touch</h2>
