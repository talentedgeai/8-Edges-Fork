...
import { allCaseStudies, getCaseStudyBySlug, getCaseStudiesByCategory, getAllCaseStudySlugs } from '@/entities/site/lib/caseStudies'
            ...
            <div className="cs-detail-media">
              {imgs.length === 0 && (
                <div className="cs-detail-img-wrap">
                  <Image src={cs.image} alt={cs.title} width={640} height={480} className="u-img" />
                </div>
              )}
              ...
              {imgs.length === 1 && (
                <div className="cs-detail-img-wrap">
                  <Image src={imgs[0]} alt={cs.title} width={640} height={480} className="u-img" priority />
                </div>
              )}
              ...
              {imgs.length === 2 && cs.beforeAfter && (
                <>
                  <div className="cs-detail-img-wrap">
                    <Image src={imgs[0]} alt={`${cs.title} before`} width={640} height={420} className="u-img" priority />
                    <div className="cs-slide-label">Before</div>
                  </div>
                  <div className="cs-detail-img-wrap">
                    <Image src={imgs[1]} alt={`${cs.title} after`} width={640} height={420} className="u-img" />
              ...
              {imgs.length === 2 && !cs.beforeAfter && (
                <>
                  <div className="cs-detail-img-wrap">
                    <Image src={imgs[0]} alt={`${cs.title} 1`} width={640} height={420} className="u-img" priority />
                  </div>
                  <div className="cs-detail-img-wrap">
                    <Image src={imgs[1]} alt={`${cs.title} 2`} width={640} height={420} className="u-img" />
                  </div>
                </>
              )}
              ...
              {imgs.length >= 3 && imgs.slice(0, 3).map((src, i) => (
                <div key={i} className="cs-detail-img-wrap">
                  <Image src={src} alt={`${cs.title} ${i + 1}`} width={640} height={420} className="u-img" priority={i === 0} />
                </div>
              ))}
            </div>
