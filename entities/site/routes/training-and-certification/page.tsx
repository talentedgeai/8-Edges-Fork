    ...
    <main>
      ...
      <section className="section">
        <div className="container">
          <div className="reveal">
            ...
            <p className="section-sub u-mt-4">A structured 12-month curriculum that builds real AI capability across your entire organization.</p>
          </div>
          <div className="program-stats u-mt-8">
            {[
              { num: '12', label: 'Months' },
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="series-grid u-mt-8">
            ...
            <div className="series-card featured reveal">
              <div className="series-badge u-accent">Series 2 · Most Popular</div>
      ...
      <section className="section">
        <div className="container">
          <div className="track-record reveal">
            <span className="section-label section-label--mint">Track Record</span>
            <h2 className="section-title site-on-dark u-mb-0">Proven Results Across Southeast Asia &amp; North America</h2>
      ...
      <section className="site-contact-blue section">
        <div className="container">
          <div className="site-contact-blue-inner">
            <div className="reveal">
              <h2 className="section-title u-mb-4">Ready to Build AI Leadership?</h2>
