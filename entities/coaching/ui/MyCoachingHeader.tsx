import type { MyCoaching } from "@/entities/coaching/lib/data/member";
  ...
  return (
    <header className="admin-coach-hero">
      ...
      <div className="admin-glance admin-coach-hero__stats">
        <Tile
          label="Next 1-1"
          value={my.nextOneOnOneOn ? formatDate(my.nextOneOnOneOn) : "Not scheduled"}
        ...
        <Tile
          label="Last recap"
          value={lastRecap ? formatDate(lastRecap.heldOn) : "—"}
