...
export const allWorkflows: Workflow[] = [
  ...
  },
  {
    ...
    category: 'Operations',
    excerpt:
      'The stand-up, read off the Workboard: a 09:30 agent posts done yesterday, doing today and blockers per team to Lark, nudges anyone whose cards went quiet, and closes every week on Wednesday with a Human and AI token report.',
    date: '2026-09-08',
    steps: 8,
  },
  {
