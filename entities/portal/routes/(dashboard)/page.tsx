...
import { getMyEvents } from "@/entities/portal/lib/events";
import { getTokenBalance } from "@/entities/portal/lib/tokens";
import { getRoadmapPreviewForActor } from "@/entities/portal/lib/backlog";
import { getBoardForClient } from "@/entities/portal/lib/boards";
...
import { PRIORITY_LABEL, type BacklogPriority } from "@/entities/portal/lib/client-backlog";
import { formatCents, formatDate, humanize } from "@/kernel/ui/format";
import {
  formatHours,
  PRIORITY_LABEL as TASK_LABEL,
  PRIORITY_TONE as TASK_TONE,
...
export default async function PortalHome() {
  ...
  // else (entities/portal/lib/time-off.ts).
  const hasAttention =
