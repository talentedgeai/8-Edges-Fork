...
import { getTokenUsage, PACK_PRICE_CENTS, PACK_TOKENS } from "@/entities/portal/lib/tokens";
import { formatLeverage } from "@/entities/portal/lib/hub-tokens";
import { PageHead } from "@/kernel/ui/PageHead";
import { MetricCard } from "@/kernel/ui/MetricCard";
import { Badge } from "@/kernel/ui/Badge";
import { formatCents, formatDate, formatHours } from "@/kernel/ui/format";
  ...
  return (
    <>
      ...
      <div className="admin-kpi-grid u-mb-5">
        ...
        <MetricCard
          label="Delivered"
          value={formatHours(usage.deliveredHours)}
