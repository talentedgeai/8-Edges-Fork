...
import { type CalendarEntry, TimeOffCalendar } from "@/entities/team";
import { formatLeaveBalance, LEAVE_TYPE_LABEL, type LeaveType } from "@/entities/team";
              ...
              <tbody>
                {directory.map((r) => (
                  <tr key={r.id}>
                    ...
                    <td>{r.approverName || "Arca Wellness"}</td>
                    <td>{r.team || muted}</td>
