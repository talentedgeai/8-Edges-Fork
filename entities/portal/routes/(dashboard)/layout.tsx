...
import { listProgramNamesForActor } from "@/entities/portal/lib/ai-programs";
...
export default async function PortalDashboardLayout({
  ...
  const [hasStaff, hasInvoicesResult, hasMeetingsResult, hasBoardResult, hasBacklogResult, programs] =
    await Promise.all([
