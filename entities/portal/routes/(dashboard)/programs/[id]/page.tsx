...
import { getBacklogForActor, getGroupsForActor } from "@/entities/portal/lib/backlog";
            ...
            {!hasRepo ? (
              ...
              <>
                <div className="admin-kpi-grid u-mb-4">
                  <MetricCard
                    label="Human Tokens"
                    value={formatHours(delivery.deliveredHours)}
