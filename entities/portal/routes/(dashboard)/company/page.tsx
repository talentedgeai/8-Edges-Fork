...
export const metadata = {
  ...
  description: "Your company's details as Arca Wellness holds them.",
};
  ...
  return (
    <div className="u-max-narrow">
      <PageHead
        eyebrow="Account"
        title="Company Profile"
        sub="What Arca Wellness holds about your company. Changes here update your account record and the address we bill to."
      />
      {profiles.map((p) => (
