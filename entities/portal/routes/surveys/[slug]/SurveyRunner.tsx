...
import { ratingBounds, type FieldType, type SurveyFieldRow } from "@/entities/company-os/client";
...
export function SurveyRunner({
  ...
  // submission fills (enables the localStorage draft) and, for an external
  // reviewer, the link's token. Both go to the API, which re-authorizes.
  ...
  return (
    <>
      ...
      <div className={styles.card}>
        {phase === "intro" && (
          <>
            <div className={`${styles.eyebrow} brand-label`}>Arca Wellness survey</div>
