...
// The read is company-os's own (deals is its table); this wrapper only applies
// the portal actor's companyScope.

import type { PortalActor } from "@/kernel/identity/portal-auth";
import { listProposalsForCompanies, type CompanyProposal } from "@/entities/company-os";

export type { CompanyProposal } from "@/entities/company-os";
