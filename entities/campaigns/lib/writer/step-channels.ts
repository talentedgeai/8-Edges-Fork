  ...
  properties: {
    outputs: {
      ...
      items: {
        ...
        properties: {
          channel: { type: "string", enum: ["email", "linkedin", "facebook", "twitter"] },
          ...
          social_style: { type: "string", description: "LinkedIn/Facebook/Twitter: the planned social style for this channel when the plan names one, else a slug from the brand's preferred social styles." },
