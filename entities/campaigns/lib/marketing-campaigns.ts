...
const CAMPAIGN_SELECT =
  "id, name, idea, objective, seo_geo_md, status, brand_id, pillar_id, starts_on, ends_on, created_at, writer_step, writer_started_at, writer_error, brands(name), marketing_pillars(name)";
