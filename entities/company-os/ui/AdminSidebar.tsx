...
import { signOut } from "@/entities/company-os/lib/actions";
...
// server-side regardless (ATS route layouts + action gates): a nav convenience, not the boundary.
    ...
    groups: [
      {
        ...
        items: [
          ...
          // Client Hubs replaces the standalone Work Boards + Client Roadmaps: pick a client, land on their hub.
