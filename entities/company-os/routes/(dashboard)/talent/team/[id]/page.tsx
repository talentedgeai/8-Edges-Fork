...
import { InvitePortalButton } from "@/entities/company-os/modules/crm/ui/InvitePortalButton";
import { ContractStartForm } from "./ContractStartForm";
import { getSignedInAuthUserIds, portalStatusOf } from "@/entities/company-os/modules/crm/portal-status";
import { listCustodyForPerson } from "@/entities/company-os/lib/equipment";
import { AssignmentsBlock } from "@/entities/company-os/ui/AssignmentsBlock";
import { AvatarUpload } from "@/entities/team";
import { SensitiveDetails } from "@/entities/company-os/modules/crm/ui/SensitiveDetails";
import { getPeopleSensitive } from "@/entities/company-os/modules/crm/people-sensitive";
import { getSensitiveViewer } from "@/kernel/identity/admin-auth";
import { getSalaryHistory } from "@/entities/company-os/lib/compensation";
...
import { getPersonSurveyResponses } from "@/entities/company-os/lib/surveys";
import { getAssignmentsForTeamMember, listAssignableCompanies } from "@/entities/company-os/lib/staff-assignments";
