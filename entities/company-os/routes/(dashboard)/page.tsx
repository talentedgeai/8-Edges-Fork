...
import {
  ...
  type OfficeKey,
  type OfficeSnapshot,
} from "@/entities/company-os/lib/office-goals";
import { KR_STATUSES, type KrStatus } from "@/entities/company-os/lib/company/edges-shared";
import { compactUsd, vsPrior, MS_DAY } from "@/entities/company-os/lib/dashboard-helpers";
import { getAdminUser } from "@/kernel/identity/admin-auth";
import { getWorkboard, listBoardManageOptions } from "@/entities/company-os/modules/boards";
