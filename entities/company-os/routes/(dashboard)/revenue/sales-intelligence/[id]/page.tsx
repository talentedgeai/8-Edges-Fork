...
import { getCall, scorecardAverage } from "@/entities/company-os/modules/crm/calls";
import { analyzeCall, isHostSpeaker } from "@/entities/company-os/modules/crm/call-analysis";
