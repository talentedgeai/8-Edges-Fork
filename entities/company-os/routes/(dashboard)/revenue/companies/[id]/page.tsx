...
import { getCompany360, getCompanyReferredBy } from "@/entities/company-os/modules/crm/companies";
import { getPortalMembershipsForCompany } from "@/entities/company-os/modules/crm/portal";
import { getAssignmentsForCompany, listActiveTeamMembers, listClientContacts } from "@/entities/company-os/lib/staff-assignments";
import { getInvoicesForCompany } from "@/entities/company-os/modules/crm/invoices";
import { getMeetingsForCompany } from "@/entities/company-os/modules/crm/meetings";
import { getSurveyResponsesForCompany } from "@/entities/company-os/lib/surveys";
...
import { getCompanyHubTeam, getLiveCardItemIds, listAssignableStaff } from "@/entities/company-os/modules/crm/company-hub";
...
import { BACKLOG_SELECT, ROADMAP_GROUPS_SELECT, type BacklogItem, type RoadmapGroup } from "@/entities/portal";
...
import { PortalMemberControls } from "@/entities/company-os/modules/crm/ui/PortalMemberControls";
import { CrmCommandBar } from "@/entities/company-os/modules/crm/ui/CrmCommandBar";
import { AssignedStaffCard } from "@/entities/company-os/ui/AssignedStaffCard";
import { CompanyDocuments, type ProgramOption } from "@/entities/company-os/modules/crm/ui/CompanyDocuments";
import { HubTeamPanel, InvoicesPanel, MeetingsPanel, hubProgramCard, moveCard } from "@/entities/team";
...
import { setMeetingPublished, setMeetingProgram } from "@/entities/company-os/modules/crm/meetings-actions";
      ...
      : [
          {
            ...
            content: boardDetail ? (
              <Workboard data={boardDetail} onMove={moveCard} extras canManage teamOptions={boardOptions.team} clientOptions={boardOptions.clients} programOptions={boardOptions.programs} viewerPersonId={viewerPersonId} />
            ) : (
