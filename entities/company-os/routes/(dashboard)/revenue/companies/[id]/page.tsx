...
import {
  ...
  listClientContacts,
} from "@/entities/company-os/lib/staff-assignments";
...
import { getCompanyHubTeam, getLiveCardItemIds } from "@/entities/company-os/modules/crm/company-hub";
import {
  fetchAll,
...
import { HubProgramsBand, HubTeamPanel, InvoicesPanel, MeetingsPanel, moveCard } from "@/entities/team";
      ...
      : [
          {
            ...
            content: boardDetail ? (
              <BoardView detail={boardDetail} onMove={moveCard} canManage teamOptions={boardOptions.team} clientOptions={boardOptions.clients} programOptions={boardOptions.programs} viewerPersonId={viewerPersonId} />
            ) : (
