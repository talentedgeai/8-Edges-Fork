...
import { OfficeGoalsCard } from "@/entities/company-os/ui/OfficeGoalsCard";
import { getOfficeGoals, healthSummary } from "@/entities/company-os/lib/office-goals";
import { one, monthsThisYear, MS_DAY } from "@/entities/company-os/lib/dashboard-helpers";
import { getSurveyScore } from "@/entities/company-os/lib/survey-scores";
import { FIXED_VND_PER_USD } from "@/entities/company-os/lib/compensation-shared";
