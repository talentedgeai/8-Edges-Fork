// Row shapes for three company_os reads that a higher-layer entity loads but a
// company-os component renders: the org chart (team_members), open headcount
// (job_requisitions) and both sides of a client account (staff_assignments +
// person_companies). The loaders live where the gate lives — /team's are in
// entities/team, the admin's companyId-scoped mirror is in
// entities/company-os/modules/crm/company-hub.ts — but the shape belongs to
