...
const CRON_META: Record<string, CronMeta> = {
  ...
  "/api/cron/weekly-sprints/": {
    name: "Weekly sprints",
    description:
      "Mondays. Opens next week's sprint (Wednesday to Tuesday) on every board with weekly sprints switched on, drafts its name and goal from the open cards, and sends each board's team chat the sprint planning board with a link to every new sprint.",
