...
// team's since Q2 — entities/team/lib/move-card.ts — and Workboard takes it
// as its `onMove` prop.)
...
export { Workboard } from "@/entities/company-os/modules/boards/ui/Workboard";
...
export type { HubTeam, OpenRole, OrgEntry } from "@/entities/company-os/lib/directory-shapes";
...
export type { TaskPriority } from "@/entities/company-os/modules/boards/types";
