...
import { recordAssetImage } from "@/entities/company-os/modules/campaigns/marketing-images";
import { imageStyleLabel } from "@/entities/company-os/modules/campaigns/style-catalogues";
