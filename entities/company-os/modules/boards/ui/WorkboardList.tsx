...
import { PRIORITY_LABEL, PRIORITY_TONE } from "@/entities/company-os/modules/boards/types";
import type { WorkboardData } from "@/entities/company-os/modules/boards/workboard";
import { setCardSprint, setTaskTokens, updateCard } from "@/entities/company-os/modules/boards/actions";
import { moveCardToBoard } from "@/entities/company-os/modules/boards/move-to-board";
...
export function WorkboardList({
  ...
  // The board's own lane move (optimistic, then moveCard), for the Status cell.
