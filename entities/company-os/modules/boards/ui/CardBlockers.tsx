...
import type { BoardCard, BoardPerson } from "@/entities/company-os/modules/boards/data";
import { addBlocker, setBlockerAssignee, toggleBlocker } from "@/entities/company-os/modules/boards/blocker-actions";
