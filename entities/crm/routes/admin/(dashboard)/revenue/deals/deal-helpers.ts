...
// The enumerated reasons the close and hand-off decisions accept; here rather
// than in actions.ts because "use server" allows only async exports.
export const LOST_REASONS = new Set([
  "price",
  "competitor",
  "no_decision",
  "bad_fit",
