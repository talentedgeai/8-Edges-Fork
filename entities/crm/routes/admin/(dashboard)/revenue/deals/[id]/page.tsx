...
export default async function DealDetailPage({ params }: { params: { id: string } }) {
  ...
  if (ref.redirect === "permanent") permanentRedirect(`${surfaceBase()}/revenue/deals/${ref.canonical}`);
  if (ref.redirect === "temporary") redirect(`${surfaceBase()}/revenue/deals/${ref.canonical}`);

  const [{ data, error }, { data: stageData }, history, campaignOptions] = await Promise.all([
