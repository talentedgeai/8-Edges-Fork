...
import AdminPage from "@/entities/crm/routes/admin/(dashboard)/revenue/inquiries/page";
export { metadata } from "@/entities/crm/routes/admin/(dashboard)/revenue/inquiries/page";

export default async function TeamInquiriesPage() {
