...
import {
  ...
  type SurveyFieldRow,
  type SurveyRow,
} from "@/entities/org/lib/surveys-schema";  // the client-safe half; lib/surveys reads the database
import {
  addField,
  deleteField,
  deleteSurvey,
...
export function SurveyBuilder({
  ...
  // The banner, the transition and the "run an action, then say what happened"
  // closure are the shared ones — see entities/company-os/ui/useActionRunner.ts.
  const { note: banner, pending, startTransition, run, router } = useActionRunner();
