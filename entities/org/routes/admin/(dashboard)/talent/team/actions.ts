...
import { upsertPeopleSensitive, type SensitiveInput } from "@/entities/crm";
...
// canViewSensitive — PII is the finance-cleared admins only; a plain admin cannot write it. The
...
// Add a salary change (the finance-cleared admins only). Append-only: the lib supersedes the
