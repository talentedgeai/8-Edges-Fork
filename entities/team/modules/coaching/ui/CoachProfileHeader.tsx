...
import { OPEN_COMMITMENT_STATUSES, RETENTION_ROOT_LABELS } from "../types";
  ...
  return (
    <header className="admin-coach-hero">
      ...
      <div className="admin-glance admin-coach-hero__stats">
        <Tile
          label="Next 1-1"
          value={nextMeeting ? formatDate(nextMeeting.heldOn) : "None scheduled"}
        ...
        <Tile
          label="Last 1-1"
          value={lastMeeting ? formatDate(lastMeeting.heldOn) : "—"}
