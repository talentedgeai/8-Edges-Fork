...
async function resolveOrCreatePerson(
  ...
  if (personError) console.error("[team/dayoff-import] people", personError);
...
async function ensureTeamMember(
  ...
  if (byDayoffError) console.error("[team/dayoff-import] team_members", byDayoffError);
  ...
  if (existingTmError) console.error("[team/dayoff-import] team_members", existingTmError);
  if (existingTm) {
...
async function importEmployee(
  ...
  if (existingError) console.error("[team/dayoff-import] time_off", existingError);
