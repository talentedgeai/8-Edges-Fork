...
import { type SensitiveRow, type OrgEntry, type OpenRole } from "@/entities/company-os";
// The org-chart and open-role shapes describe company_os rows and live in
// company-os (entities/company-os/lib/directory-shapes.ts) so the admin
// OrgChart, which sits a layer below /team, can render them without importing
// upward. Re-exported so team's own importers keep reading them from here.
export type { OrgEntry, OpenRole } from "@/entities/company-os";
