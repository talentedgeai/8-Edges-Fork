...
import { getHubWorkboardForActor, getActorClientCompanies, companyHasPrograms } from "@/entities/team/modules/hub/clients";
...
export default async function TeamClientBoardTab({ params }: { params: { companyId: string } }) {
  ...
  // moveCard re-checks membership server-side, so this gate is UI only.
