...
import { getRepoStory, listHoursLedger, listFocusBudgets, type RepoStoryBlock } from "@/entities/htt";
import { HoursLedger } from "@/entities/htt/client";
import { teamOverrideDayHours, teamClearDayHours, teamSetFocusBudget, teamRescanHours } from "@/entities/team/modules/hub/hours-actions";
...
import { Tabs, type TabDef, BarChart, Workboard, listBoardManageOptions } from "@/entities/company-os";
...
export default async function TeamProgramDetailPage({
  ...
  const [boardDetail, boardOptions, ledger] = await Promise.all([
            ...
            <>
              ...
              <div className="u-mt-4">
                <HoursLedger
                  ...
                  budgets={budgets}
                  viewerPersonId={actor.personId}
                  canEditAll={actor.isAdmin}
                  overrideAction={teamOverrideDayHours}
                  clearAction={teamClearDayHours}
                  budgetAction={teamSetFocusBudget}
                  rescanAction={teamRescanHours}
                />
              </div>
            </>
          )}
