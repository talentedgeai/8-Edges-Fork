...
import { getClientRoadmapSnippets } from "@/entities/team/modules/hub/clients";
import { getMyRecentTasks } from "@/entities/team/lib/boards";
import { PageHead } from "@/kernel/ui/PageHead";
import { Badge, type BadgeTone } from "@/kernel/ui/Badge";
import { PRIORITY_LABEL, type BacklogPriority } from "@/entities/portal";
...
import { PRIORITY_LABEL as TASK_PRIORITY_LABEL, PRIORITY_TONE as TASK_PRIORITY_TONE } from "@/entities/company-os";
  ...
  return (
    <>
      ...
      <div className="admin-glance">
        ...
        <div className="admin-team-glance-cell">
          <span className="admin-team-glance-label brand-label">With Edge8 since</span>
      ...
      >
        ...
        <span className="admin-btn admin-btn--primary u-shrink-none u-no-events">
          Start on AIOlabz →
        </span>
      </a>
