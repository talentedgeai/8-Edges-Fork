...
import { AddToRoster } from "@/entities/team/modules/coaching/ui/AddToRoster";
    ...
    <Link href={`/team/coaching/${row.profileId}`} className="admin-card admin-coach-card">
      <div className="admin-coach-card-head">
        {row.member.avatarUrl ? (
          <Image src={row.member.avatarUrl} alt="" width={40} height={40} className="admin-avatar admin-avatar--lg" />
        ) : (
