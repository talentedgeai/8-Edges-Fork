...
- year_basis: How the leave year is counted: calendar (resets 1 January) or anniversary (resets on the anniversary of the day probation ended). Valid values: [calendar, anniversary]
...
- status: Campaign state. Valid values: [draft, active, done, archived].
