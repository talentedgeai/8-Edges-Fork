 ...
 *   blue, blue-bright, mint and dark come from lib/design/palette.json
 */
...
// Brand hex comes from lib/design/palette.json, the one file (with tokens.css) allowed to hold it.
const PALETTE = require('./design/palette.json')
const COLORS = {
  blue: PALETTE.blue,
