...
// The body lives in entities/portal/routes/portal/(dashboard)/programs/page; this file
...
// its mounts.ts.
export { default } from "@/entities/portal/routes/portal/(dashboard)/programs/page";
