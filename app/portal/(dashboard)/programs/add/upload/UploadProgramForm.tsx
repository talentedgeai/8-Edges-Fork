...
// Public publishable key — mirrors what the supabase browser client sends on the
// signed-upload PUT. The signed URL itself carries the authorization; this is
// belt-and-suspenders and harmless if absent.
