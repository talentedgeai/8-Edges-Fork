...
// The body lives in entities/portal/routes/portal/(dashboard)/time-off/page; this file
...
// its mounts.ts.
export { default } from "@/entities/portal/routes/portal/(dashboard)/time-off/page";
