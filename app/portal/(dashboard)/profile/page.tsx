...
// The body lives in entities/portal/routes/portal/(dashboard)/profile/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/portal/routes/portal/(dashboard)/profile/page";
