...
// The body lives in entities/portal/routes/portal/(dashboard)/requests/[id]/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/portal/routes/portal/(dashboard)/requests/[id]/page";
