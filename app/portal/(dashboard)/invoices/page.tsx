...
// The body lives in entities/portal/routes/portal/(dashboard)/invoices/page; this file
...
// its mounts.ts.
export { default } from "@/entities/portal/routes/portal/(dashboard)/invoices/page";
