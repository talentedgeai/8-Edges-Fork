...
// The body lives in entities/portal/routes/portal/(auth)/change-password/page; this file
...
// its mounts.ts.
export { default } from "@/entities/portal/routes/portal/(auth)/change-password/page";
