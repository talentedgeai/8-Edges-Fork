// Route file: the body lives in entities/retreats/routes/reserve/saigon-private/opengraph-image.tsx (ME-06).
...
export { default, size, contentType, alt } from "@/entities/retreats/routes/reserve/saigon-private/opengraph-image";
