// Route file: the body lives in entities/retreats/routes/reserve/saigon-private/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/reserve/saigon-private/page";
