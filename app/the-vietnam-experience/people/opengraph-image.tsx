// Route file: the body lives in entities/retreats/routes/the-vietnam-experience/people/opengraph-image.tsx (ME-06).
...
export { default, size, contentType, alt } from "@/entities/retreats/routes/the-vietnam-experience/people/opengraph-image";
