// Route file: the body lives in entities/retreats/routes/the-vietnam-experience/people/dave/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/the-vietnam-experience/people/dave/page";
