// Route file: the body lives in entities/retreats/routes/the-vietnam-experience/place/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/the-vietnam-experience/place/page";
