...
vi.mock("@/lib/site-origin", () => ({ getSiteOrigin: () => "https://edge8.ai" }));
vi.mock("@/lib/events-server", () => ({ newTicketCode: () => "TICKET-CODE" }));

import { handleFailed, handlePaid } from "@/app/api/stripe/webhook/fulfilment";
