// Route file: the body lives in entities/retreats/api/vietnam-adventure-flight-info/route.ts (ME-06).
...
export { POST } from "@/entities/retreats/api/vietnam-adventure-flight-info/route";
