    ...
    <main>
        ...
        <div className="container">
          <div className="page-hero-inner">
            ...
            <p style={{ marginTop: 20, fontSize: 14 }}>
              <a href={REPO_URL} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--grey-mid)' }}>
      ...
      <section className="section" style={{ background: 'var(--tint)' }}>
        <div className="container">
          ...
          <p className="section-sub reveal" style={{ marginTop: 40 }}>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="e8a-btn-row reveal" style={{ marginTop: 48 }}>
            <a href={ATLAS_URL} className="btn btn-primary">Explore the Data Atlas</a>
          </div>
          <p className="section-sub reveal" style={{ marginTop: 16, textAlign: 'center', marginLeft: 'auto', marginRight: 'auto' }}>
      ...
      <section className="section" style={{ background: 'var(--tint)' }}>
        <div className="container">
          ...
          <p className="section-sub reveal" style={{ marginTop: 32 }}>
      ...
      <section className="contact-blue section">
        <div className="container">
          <div className="contact-blue-inner">
            <div className="reveal">
              <h2 className="section-title" style={{ marginBottom: 16 }}>Stop Renting Your Company&apos;s Brain</h2>
