...
// The body lives in entities/team/routes/team/(auth)/change-password/page; this file
...
// its mounts.ts.
export { default } from "@/entities/team/routes/team/(auth)/change-password/page";
