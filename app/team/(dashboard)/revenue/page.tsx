...
// The body lives in entities/crm/routes/team/(dashboard)/revenue/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/crm/routes/team/(dashboard)/revenue/page";
