...
// The body lives in entities/crm/routes/team/(dashboard)/revenue/companies/[id]/page; this file
...
// its mounts.ts.
export { default } from "@/entities/crm/routes/team/(dashboard)/revenue/companies/[id]/page";
