...
// The body lives in entities/crm/routes/team/(dashboard)/revenue/deals/[id]/page; this file
...
// its mounts.ts.
export { default, generateMetadata } from "@/entities/crm/routes/team/(dashboard)/revenue/deals/[id]/page";
