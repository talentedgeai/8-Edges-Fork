...
// The body lives in entities/retreats/routes/team/(dashboard)/revenue/events/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/retreats/routes/team/(dashboard)/revenue/events/page";
