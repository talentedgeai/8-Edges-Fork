...
// The body lives in entities/company-os/routes/team/(dashboard)/revenue/products/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/company-os/routes/team/(dashboard)/revenue/products/page";
