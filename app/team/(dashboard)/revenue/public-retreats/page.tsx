...
// The body lives in entities/retreats/routes/team/(dashboard)/revenue/public-retreats/page; this file
...
// its mounts.ts.
export { default } from "@/entities/retreats/routes/team/(dashboard)/revenue/public-retreats/page";
