...
// The body lives in entities/team/routes/team/(dashboard)/boards/[slug]/epics/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/team/routes/team/(dashboard)/boards/[slug]/epics/page";
