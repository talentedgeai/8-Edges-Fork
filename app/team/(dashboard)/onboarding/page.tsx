...
// The body lives in entities/onboarding/routes/team/(dashboard)/onboarding/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/onboarding/routes/team/(dashboard)/onboarding/page";
