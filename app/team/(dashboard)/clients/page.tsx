...
// The body lives in entities/team/routes/team/(dashboard)/clients/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/team/routes/team/(dashboard)/clients/page";
