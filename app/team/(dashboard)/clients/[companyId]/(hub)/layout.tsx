...
// The body lives in entities/team/routes/team/(dashboard)/clients/[companyId]/(hub)/layout; this file
...
// its mounts.ts.
export { default } from "@/entities/team/routes/team/(dashboard)/clients/[companyId]/(hub)/layout";
