...
// The body lives in entities/team/routes/team/(dashboard)/profile/id-image/[side]/route; this file
...
// its mounts.ts.
export { GET } from "@/entities/team/routes/team/(dashboard)/profile/id-image/[side]/route";
