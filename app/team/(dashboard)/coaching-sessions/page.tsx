...
// The body lives in entities/coaching/routes/team/(dashboard)/coaching-sessions/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/coaching/routes/team/(dashboard)/coaching-sessions/page";
