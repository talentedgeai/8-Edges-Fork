...
// The body lives in entities/team/routes/team/(dashboard)/vendors/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/team/routes/team/(dashboard)/vendors/page";
