// Route file: the body lives in entities/retreats/routes/vietnam-adventure-flight-info/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/vietnam-adventure-flight-info/page";
