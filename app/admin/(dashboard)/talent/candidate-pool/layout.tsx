...
// The body lives in entities/hiring/routes/admin/(dashboard)/talent/candidate-pool/layout; this file
...
// its mounts.ts.
export { default } from "@/entities/hiring/routes/admin/(dashboard)/talent/candidate-pool/layout";
