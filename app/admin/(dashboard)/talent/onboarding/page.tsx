...
// The body lives in entities/onboarding/routes/admin/(dashboard)/talent/onboarding/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/onboarding/routes/admin/(dashboard)/talent/onboarding/page";
