...
// The body lives in entities/hiring/routes/admin/(dashboard)/talent/applications/layout; this file
...
// its mounts.ts.
export { default } from "@/entities/hiring/routes/admin/(dashboard)/talent/applications/layout";
