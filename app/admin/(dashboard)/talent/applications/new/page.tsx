...
// The body lives in entities/hiring/routes/admin/(dashboard)/talent/applications/new/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/hiring/routes/admin/(dashboard)/talent/applications/new/page";
