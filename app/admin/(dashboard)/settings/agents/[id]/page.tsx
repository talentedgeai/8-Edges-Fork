...
// The body lives in entities/company-os/routes/admin/(dashboard)/settings/agents/[id]/page; this file
...
// its mounts.ts.
export { default } from "@/entities/company-os/routes/admin/(dashboard)/settings/agents/[id]/page";
