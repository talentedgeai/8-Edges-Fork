...
// The body lives in entities/company-os/routes/admin/(dashboard)/settings/assume/page; this file
...
// its mounts.ts.
export { default } from "@/entities/company-os/routes/admin/(dashboard)/settings/assume/page";
