...
// The body lives in entities/company-os/routes/admin/(dashboard)/settings/quickbooks/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/company-os/routes/admin/(dashboard)/settings/quickbooks/page";
