...
// The body lives in entities/ideas/routes/admin/(dashboard)/innovation/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/ideas/routes/admin/(dashboard)/innovation/page";
