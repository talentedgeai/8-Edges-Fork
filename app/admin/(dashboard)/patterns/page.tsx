      ...
      <div className="admin-pat-stack">
        ...
        <Section title="Record page pieces" sub="Classes added while moving the last inline styles off the record pages. Compose them; do not add new ones for the same job.">
          <div className="u-stack u-gap-4">
            ...
            <div className="admin-transcript-seg">.admin-transcript-seg keeps line breaks
and wraps long words in transcripts.</div>
        ...
        <Section title="Team and portal pieces" sub="Level cards with pushed footers, overview prose, disclosure summaries, read-only priority pills.">
          <div className="u-stack u-gap-4">
            ...
            <div className="admin-backlog-portal">
              <span className="admin-backlog-portal-pills"><span className="admin-backlog-portal-pill admin-backlog-portal-pill--static on-now">Now</span><span className="admin-backlog-portal-pill admin-backlog-portal-pill--static on-later">Later</span></span>
              <span className="u-sm u-muted u-ml-2">.admin-backlog-portal-pill--static · read-only priority pill</span>
            </div>
          </div>
        </Section>
