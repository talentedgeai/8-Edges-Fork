...
// The body lives in entities/company-os/routes/admin/(dashboard)/operations/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/company-os/routes/admin/(dashboard)/operations/page";
