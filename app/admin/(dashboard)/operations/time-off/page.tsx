...
// The body lives in entities/time-off/routes/admin/(dashboard)/operations/time-off/page; this file
...
// its mounts.ts.
export { default } from "@/entities/time-off/routes/admin/(dashboard)/operations/time-off/page";
