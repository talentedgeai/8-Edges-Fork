...
// The body lives in entities/org/routes/admin/(dashboard)/operations/surveys/[id]/results/page; this file
...
// its mounts.ts.
export { default } from "@/entities/org/routes/admin/(dashboard)/operations/surveys/[id]/results/page";
