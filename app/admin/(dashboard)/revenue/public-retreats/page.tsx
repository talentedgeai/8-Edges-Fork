...
// The body lives in entities/retreats/routes/admin/(dashboard)/revenue/public-retreats/page; this file
...
// its mounts.ts.
export { default } from "@/entities/retreats/routes/admin/(dashboard)/revenue/public-retreats/page";
