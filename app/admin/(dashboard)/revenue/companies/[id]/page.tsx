...
// The body lives in entities/crm/routes/admin/(dashboard)/revenue/companies/[id]/page; this file
...
// its mounts.ts.
export { default } from "@/entities/crm/routes/admin/(dashboard)/revenue/companies/[id]/page";
