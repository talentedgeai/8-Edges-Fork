...
// The body lives in entities/crm/routes/admin/(dashboard)/revenue/meetings/new/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/crm/routes/admin/(dashboard)/revenue/meetings/new/page";
