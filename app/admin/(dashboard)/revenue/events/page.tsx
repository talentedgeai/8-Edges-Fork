...
// The body lives in entities/retreats/routes/admin/(dashboard)/revenue/events/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/retreats/routes/admin/(dashboard)/revenue/events/page";
