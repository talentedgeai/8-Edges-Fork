...
// The body lives in entities/org/routes/admin/(dashboard)/company/org/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/org/routes/admin/(dashboard)/company/org/page";
