...
// The body lives in entities/company-os/routes/admin/(dashboard)/not-found; this file
...
// its mounts.ts.
export { default } from "@/entities/company-os/routes/admin/(dashboard)/not-found";
