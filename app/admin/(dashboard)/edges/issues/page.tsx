...
// The body lives in entities/ideas/routes/admin/(dashboard)/edges/issues/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/ideas/routes/admin/(dashboard)/edges/issues/page";
