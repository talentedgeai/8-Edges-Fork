...
// The body lives in entities/boards/routes/admin/(dashboard)/edges/sprint-planning/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/boards/routes/admin/(dashboard)/edges/sprint-planning/page";
