...
// The body lives in entities/boards/routes/admin/(dashboard)/boards/[slug]/epics/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/boards/routes/admin/(dashboard)/boards/[slug]/epics/page";
