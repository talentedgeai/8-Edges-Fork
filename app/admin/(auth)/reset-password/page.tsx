...
// The body lives in entities/company-os/routes/admin/(auth)/reset-password/page; this file
...
// its mounts.ts.
export { default } from "@/entities/company-os/routes/admin/(auth)/reset-password/page";
