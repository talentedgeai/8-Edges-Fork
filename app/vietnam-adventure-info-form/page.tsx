// Route file: the body lives in entities/retreats/routes/vietnam-adventure-info-form/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/vietnam-adventure-info-form/page";
