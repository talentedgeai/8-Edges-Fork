// Route file: the body lives in entities/retreats/routes/my-retreat/[slug]/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/my-retreat/[slug]/page";
