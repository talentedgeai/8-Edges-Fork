    ...
    <main>
      ...
      <section className="section" style={{ background: 'var(--tint)' }}>
        <div className="container">
          ...
          <div className="wf-table-wrap" style={{ marginTop: 32 }}>
      ...
      <section className="section">
        <div className="container">
          ...
          <h3
            style={{ fontFamily: 'var(--font-display)', fontSize: 20, color: 'var(--dark)', margin: '28px 0 0' }}
          >
          ...
          <h3
            style={{ fontFamily: 'var(--font-display)', fontSize: 20, color: 'var(--dark)', margin: '40px 0 0' }}
          >
            Workstream B · Confidential wage records
          </h3>
          <div className="wf-open" style={{ marginTop: 20 }}>
            <h3>Dave &amp; Mai only</h3>
            <p>
      ...
      <section className="section">
        <div className="container">
          ...
          <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--dark)', margin: '48px 0 0' }}>
            Definition of Done
          </h3>
      ...
      <section className="section" style={{ background: 'var(--tint)' }}>
        <div className="container">
          <span className="section-label" style={{ background: 'var(--white)' }}>Scope</span>
