    ...
    <main>
      ...
      <section className="section site-wf-section--dark">
        <div className="container">
          ...
          <div className="site-wf-hero-meta u-mb-6">
            <span className="site-wf-meta-chip">Plan <strong>5D Brief</strong></span>
            <span className="site-wf-meta-chip">Document <strong>7 elements</strong></span>
            <span className="site-wf-meta-chip">Assign <strong>Centaur Map</strong></span>
            <span className="site-wf-meta-chip">Ship <strong>3 stage gates</strong></span>
          </div>
