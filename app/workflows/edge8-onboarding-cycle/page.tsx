      ...
      <section className="section u-pb-8">
        <div className="container">
          ...
          <div className="site-wf-lanes-head">
            <div className="site-wf-lane-label site-wf-lane-label-admin">Manager</div>
            <div className="site-wf-lane-label site-wf-lane-label-system">System + AI</div>
            <div className="site-wf-lane-label site-wf-lane-label-contractor">New hire</div>
          </div>
