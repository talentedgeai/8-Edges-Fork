// Route file: the body lives in entities/retreats/routes/saigon-private/layout.tsx (ME-06).
...
export { default } from "@/entities/retreats/routes/saigon-private/layout";
