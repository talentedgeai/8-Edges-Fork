// Route file: the body lives in entities/retreats/routes/saigon-private/page.tsx (ME-06).
...
export { default, metadata } from "@/entities/retreats/routes/saigon-private/page";
