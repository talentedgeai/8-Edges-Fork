...
import { analyzeCall } from "../../lib/admin/call-analysis";
...
const out = rows.map((r: { id: string; title: string; started_at: Date | null; duration_seconds: number | null; transcript: string }) => {
