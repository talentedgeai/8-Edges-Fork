...
const SKIP_FILE = /(opengraph-image|icon\.tsx$|apple-icon|lib\/design\/palette\.json$|\/email\.ts$|\/emails?\/|goal-notify)/;
...
const STYLED_INLINE_CEILING = Number(process.env.STYLED_INLINE_CEILING ?? 13);
