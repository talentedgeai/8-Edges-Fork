...
// `app` is the composition root, `kernel` the shared design-system primitives and
// `entities` every product block; `components/` and `lib/` no longer exist (ME-13).
...
for (const file of SCAN_DIRS.flatMap((d) =>
