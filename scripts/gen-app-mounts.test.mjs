...
describe("surface shells follow their entity", () => {
  ...
  it("mounts the counts the docs quote — 469 for edge8, 151 for minimal", () => {
    // The numbers appear in CLAUDE.md and the PR text; a generator change that
    // moves them should have to say so here.
    expect(Object.keys(generateMounts(root, "edge8")).length).toBe(469);
    expect(Object.keys(generateMounts(root, "minimal")).length).toBe(151);
  });
