...
// cross-entity import ratchet (scripts/check-entity-imports.mjs) — and the
// table-ownership ratchet (ME-02) will be the third. Keeping the resolver here
...
// extensionless stem: `lib/env` owns lib/env.ts, lib/env.test.ts and lib/env/.
// Files under app/ that no entity claims belong to the composition root, named
// "app"; anything else unclaimed is "unassigned" so the ratchet can show it.
//
