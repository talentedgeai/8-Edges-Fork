...
import { archiveCompany, restoreCompany } from "@/app/admin/(dashboard)/revenue/companies/actions";
import { archivePerson, restorePerson } from "@/app/admin/(dashboard)/contacts/actions";
import { activateCompanyAffiliate, deactivateCompanyAffiliate } from "@/app/admin/(dashboard)/revenue/affiliates/actions";
