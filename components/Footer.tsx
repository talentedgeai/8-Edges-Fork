    ...
    <footer>
      <div className="container">
        <div className="site-footer-top">
          ...
          <div>
            <div className="site-footer-col-title">Services</div>
          ...
          <div>
            <div className="site-footer-col-title">Case Studies</div>
            <div className="site-footer-links">
              <Link href="/ai-programs">AI Programs</Link>
            </div>
            <div className="site-footer-col-title u-mt-6">Company</div>
            <div className="site-footer-links">
        ...
        <div className="site-footer-bottom">
          <div className="site-footer-copy">© 2026 by Edge8. All rights reserved.</div>
