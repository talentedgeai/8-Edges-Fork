...
// restricted is gated to a smaller set — the finance-cleared admins — checked SERVER-SIDE so
...
// set — currently the finance-cleared admins. It is the SAME set already cleared for sensitive
